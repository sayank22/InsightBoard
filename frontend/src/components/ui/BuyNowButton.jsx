    ...
    return (
        <div className="fixed top-1/2 right-0 z-50 -translate-y-1/2">
            <a
                ...
                className="group flex items-center gap-2 rounded-l-xl bg-gradient-to-r from-rose-500 to-pink-600 px-4 py-3 text-sm font-bold text-white shadow-lg shadow-rose-500/30 transition-all duration-300 hover:pr-6 hover:shadow-rose-500/50"
            >
